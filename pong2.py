...
# --- functions ---
def super_power():
    #random time between 15-40s spaw at a random place, stays for 10s
    '''Paddle mais rapido, mais bolinhas, não levar ponto, adversario mais lento'''
    pass

def super_desvantage():
    #random time between 15-40s spaw at a random place, stays for 10s
    '''Ficar mais lento'''
    pass
